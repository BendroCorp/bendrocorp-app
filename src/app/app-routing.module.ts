...
const routes: Routes = [
    ...
    { path: 'forms', component: ReportsComponent, canActivate: [AuthGuardService, MemberAuthGuardService] },
    { path: 'forms/templates', component: TemplatesComponent, canActivate: [AuthGuardService, MemberAuthGuardService] },
    { path: 'forms/templates/:template_id', component: TemplateEditorComponent, canActivate: [AuthGuardService, MemberAuthGuardService] },
    { path: 'forms/:report_id', component: ReportDetailsComponent, canActivate: [AuthGuardService, MemberAuthGuardService] },
    ...
    { path: 'discord_callback', component: DiscordCallbackComponent, canActivate: [AuthGuardService] },
